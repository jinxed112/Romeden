...
const Navbar: React.FC = () => {
  ...
  // ✅ NOUVEAU: Bloquer le scroll quand le menu mobile est ouvert
  useEffect(() => {
    if (isMobileMenuOpen) {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-md hover:bg-gray-100 transition-colors z-[60]"
            >
      ...
      {/* ✅ NOUVEAU: Menu mobile avec z-index très élevé */}
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-[9999] bg-black/20 backdrop-blur-sm">
          ...
          {/* Menu content */}
          <div className="absolute top-16 left-0 right-0 bottom-0 bg-white/98 backdrop-blur-md shadow-2xl">
